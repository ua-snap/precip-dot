...
if __name__ == '__main__':
    ...
    file_path = '/workspace/Shared/Tech_Projects/DOT/project_data/NOAA_Atlas14/warped_to_wrf'
    ...
    for group_name in groups:
        ...
        out_fn = '/workspace/Shared/Tech_Projects/DOT/project_data/NOAA_Atlas14/netcdf/pr_freq_noaa-atlas14_ak_{}_wrf_grid.nc'.format(group_name)
