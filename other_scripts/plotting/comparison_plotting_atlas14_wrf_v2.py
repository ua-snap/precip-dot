...
diff.to_csv(os.path.join(base_path,'compare_atlas14_wrf','pf_compare_area_wide_mean.csv'))
...
# mean = {i:diff.sel(intervals=i).mean(axis=(1,2)).values for i in intervals}
# mean_df = pd.DataFrame(mean, index=durations)
diff.to_csv(os.path.join(base_path,'compare_atlas14_wrf','pf-lowerlimit_compare_area_wide_mean.csv'))
...
# mean = {i:diff.sel(intervals=i).mean(axis=(1,2)).values for i in intervals}
# mean_df = pd.DataFrame(mean, index=durations)
diff.to_csv(os.path.join(base_path,'compare_atlas14_wrf','pf-upperlimit_compare_area_wide_mean.csv'))
